...
export const myProjects = [
  {
    title: 'CodeForge',
    desc: 'A SaaS Code Editor project that allows users to create and edit code snippets, view their code, and share code snippets with friends.',
    subdesc:
      'Built with Next.js, Tailwind CSS, Convex, and TypeScript, CodeForge ensures a smooth and efficient code editor experience.',
